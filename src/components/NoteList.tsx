export default function NoteList({ notes }: { notes: [] }) {
  return (
      ...
      {notes.map((note) => (
        ...
        >
          ...
          <div className='flex items-center justify-between mb-2'>
            <div className='text-sm-fluid rounded-full h-6 w-6 flex justify-center items-center bg-neutral font-semibold text-dark'>
              {note.id}
            </div>
            <span
